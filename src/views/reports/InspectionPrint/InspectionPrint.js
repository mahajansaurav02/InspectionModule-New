...
const InspectionPrint = React.forwardRef(({ 
    reportData 
}, ref) => {
                                    ...
                                    <CCol xs={12}>
                                        ...
                                        <div className="table-responsive">
                                            <CTable bordered className="text-center mb-4">
                                                <CTableHead>
                                                    <CTableRow className="bg-light">
                                                        <CTableHeaderCell width="20%">१८० दिवसापेक्षा जास्त दिवस प्रलंबित</CTableHeaderCell>
                                                        <CTableHeaderCell width="20%">९० ते १८० दिवसातील प्रलंबित</CTableHeaderCell>
                                                        <CTableHeaderCell width="20%">३० ते ९० दिवसातील प्रलंबित</CTableHeaderCell>
                                                        <CTableHeaderCell width="20%">३० दिवसा पेक्षा कमी दिवस प्रलंबित</CTableHeaderCell>
