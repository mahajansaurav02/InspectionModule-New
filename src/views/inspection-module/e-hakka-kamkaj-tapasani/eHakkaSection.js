  ...
  const mainCards = [
    {
      ...
      subCards: [{ id: 'main1', title: 'किमान ५ तपासणी करणे अनिवार्य आहे' }],
    },
    {
      id: 'card2',
      ...
      subCards: [
        {
          id: '1',
          title: '१८० दिवसापेक्षा जास्त दिवस प्रलंबित',
          description: '(१००% तपासणी अनिवार्य)',
        },
        { id: '2', title: '९० ते १८०  दिवसातील प्रलंबित', description: '(१००% तपासणी अनिवार्य)' },
        {
          id: '3',
          title: '३० ते ९० दिवसातील प्रलंबित',
          description: '(किमान ५०% तपासणी अनिवार्य)',
        },
        {
          id: '4',
          title: '३० दिवसा पेक्षा कमी दिवस प्रलंबित',
          description: '(तपासणी आवश्यक नाही)',
        },
      ],
    },
  ]
  ...
  return (
    <>
      <div className={styles.headerWrapper}>
        <div className={styles.header}>इ - हक्क प्रणाली कामकाज तपासणी (Online)</div>
      </div>

      <div className={styles['cards-container']}>
        {mainCards.map((card) => (
          <div key={card.id} className={styles['main-card-accordion']}>
            <div className={styles['accordion-header']} onClick={() => handleHeaderClick(card.id)}>
              <h2 className={styles['accordion-title']}>{card.title}</h2>
              <CIcon
                icon={cilChevronBottom}
                className={`${styles['accordion-icon']} ${
                  expandedCardId === card.id ? styles.expanded : ''
                }`}
              />
            </div>
            ...
            <div
              className={`${styles['accordion-body']} ${
                expandedCardId === card.id ? styles.open : ''
              }`}
            >
