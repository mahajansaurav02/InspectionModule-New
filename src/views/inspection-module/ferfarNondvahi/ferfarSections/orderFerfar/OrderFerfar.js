    ...
    <>
      ...
      <CContainer className="mt-4">
        <CCard className="shadow-lg border-0">
          ...
          <CCardBody>
            <ol className="ps-3">
              <li className="mb-2">आदेशाप्रमाणे नोंद घेतली आहे का?</li>
              <li className="mb-2">
                आदेश फेरफाराशी संबंधित सर्व दस्तऐवज (आदेश व अनुषंगिक कागदपत्रे) अपलोड केले असल्याची
                खात्री करा.
              </li>
              <li className="mb-2">आदेश फेरफारा नामंजूर करता येत नाही याची बाब तपासा .</li>
              <li className="mb-2">
                क. जा. प. /आकारफोड/फाळणी बारा इ. नोंदीचा फेरफार, जुना ७/१२ बंद करून नवीन पोट हिस्से
                तयार करणे या फेरफार प्रकारातून घेणे बंधनकारक आहे. सदर फेरफार नोंदवताना ‘आदेश दस्तऐवज
                (7/12 बंद करणे)’ व ‘आदेशाने नविन 7/12 तयार करणे’ अथवा ‘कलम 155 च्या आदेशाने नवीन
                ७/१२ तयार करणे’ या पर्यायांचा वापर करण्यात आला नाही याची तपासणी करावी.
              </li>
              <li className="mb-2">नामंजूर केलेले आदेश फेरफार तपासा.</li>
              <li className="mb-2">
