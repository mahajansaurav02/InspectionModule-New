      ...
      <CContainer className="mt-4">
        <CCard className="shadow-lg border-0">
          ...
          <CCardBody>
            ...
            <ol className="ps-3">
              <li className="mb-2">
                 दिनांक १ ऑगस्ट २०२४ ते ३१ जुलै २०२४ या कालावधीतील खरेदी,वारस,गहाणखत,मृत्युपत्र, फेरफार उपलब्द करून देण्यात आले आहे.तपासणी साठी ७/१२,फेरफार,नोंदणी दस्त,उपलोड केलेले आदेश/दस्त उपलब्ध करून देण्यात आले आहे. {' '}
              </li>
              <li className="mb-2">
                दस्त किवा आदेश प्रमाणे फेरफार घेण्यात आले आहे कि नाही ? तसेच दस्ता प्रमाणे ७/१२ वर योग्य प्रकारे अंमलबजावणी झाले आहे काय ? याची तपासणी अधिकारी यांनी खात्री करावी..{' '}
              </li>
              {/* <li className="mb-2">
