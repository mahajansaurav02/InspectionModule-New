      ...
      <CContainer className="mt-4">
        <CCard className="shadow-lg border-0">
          ...
          <CCardBody>
            ...
            <ol className="ps-3">
              <li className="mb-2">
                 आदेशाप्रमाणे नोंद घेतली आहे का? वर्ग २ चे १ मध्ये बदल झाले आहे काय ? बदल झाले असल्यास आदेशप्रमाणे झाले असल्याची खात्री करा. {' '}
              </li>
              <li className="mb-2">
            ...
            आदेशावर स्थगिती आदेश असल्यास स्थगितीची इ फेरफार आज्ञावली मध्ये नोंदणी केली आहे काय.{' '}
              ...
              <li className="mb-2">
             नियंत्रीत सत्ता प्रकार असलेले भूमापन क्रमांकवर घेण्यात आलेले फेरफार आदेशानुसार योग्य घेण्यात आल्याची खात्री करा.{' '}
              </li>
              <li className="mb-2">
             ७/१२ मध्ये भू-धारणा वर्ग १ चे २ असलेले दोन्ही खातेदार एकाच ७/१२ मध्ये आहे काय याची खात्री करा. 
{' '}
              </li>
              <li className="mb-2">
             भू-धारणा वर्ग २ चे १ मध्ये बदल झाले असल्यास उप-अधीक्षक यांच्या कडे नवीन पोट हिस्सा तयार करण्याची प्रक्रिया झाली आहे काय.?{' '}
              </li>
              {/* <li className="mb-2">
